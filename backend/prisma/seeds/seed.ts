...
async function seedSkills() {
  const skillInputs = [
    ...
    },
    {
      name: 'Strings',
      slug: 'strings',
      description: 'String parsing, pattern matching, normalization, and character frequency.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 1,
      colorCode: '#0891b2',
      estimatedHours: 7,
    ...
    },
    {
      name: 'Linked Lists',
      slug: 'linked-lists',
      description: 'Pointer manipulation, fast-slow pointers, reversal, and merge patterns.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 2,
      colorCode: '#0f766e',
      estimatedHours: 7,
    ...
    },
    {
      name: 'Stacks',
      slug: 'stacks',
      description: 'Monotonic stacks, expression parsing, and nested state tracking.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 2,
      colorCode: '#4f46e5',
      estimatedHours: 6,
    ...
    },
    {
      name: 'Queues',
      slug: 'queues',
      description: 'FIFO processing, deques, sliding windows, and breadth-first traversal.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 2,
      colorCode: '#0284c7',
      estimatedHours: 5,
    ...
    },
    {
      name: 'Trees',
      slug: 'trees',
      description: 'Binary trees, BSTs, traversal, depth, and recursive tree reasoning.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 3,
      colorCode: '#65a30d',
      estimatedHours: 12,
    ...
    },
    {
      name: 'Graphs',
      slug: 'graphs',
      description: 'Graph traversal, shortest paths, topological ordering, and connectivity.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 4,
      colorCode: '#9333ea',
      estimatedHours: 14,
    ...
    },
    {
      ...
      description: 'Top-k selection, streaming order, scheduling, and heap invariants.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 3,
      colorCode: '#db2777',
      estimatedHours: 8,
    ...
    },
    {
      name: 'Tries',
      slug: 'tries',
      description: 'Prefix trees for dictionaries, autocomplete, and word search problems.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 3,
      colorCode: '#7c2d12',
      estimatedHours: 6,
    ...
    },
    {
      name: 'Union Find',
      slug: 'union-find',
      description: 'Disjoint sets, connected components, path compression, and Kruskal-style reasoning.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 3,
      colorCode: '#be123c',
      estimatedHours: 6,
    ...
    },
    {
      name: 'Sorting',
      slug: 'sorting',
      description: 'Comparator design, custom ordering, stability, and sort-based problem reductions.',
    ...
    },
    {
      name: 'Binary Search',
      slug: 'binary-search',
      description: 'Search space reduction, lower bounds, answer search, and rotated arrays.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 2,
      colorCode: '#1d4ed8',
      estimatedHours: 7,
    ...
    },
    {
      name: 'Two Pointers',
      slug: 'two-pointers',
      description: 'Opposite-end scans, fast-slow pointers, pair search, and sorted-array patterns.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 2,
      colorCode: '#059669',
      estimatedHours: 6,
    ...
    },
    {
      name: 'Sliding Window',
      slug: 'sliding-window',
      description: 'Fixed and variable windows for substring, subarray, and frequency constraints.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 2,
      colorCode: '#0d9488',
      estimatedHours: 7,
    ...
    },
    {
      name: 'Recursion',
      slug: 'recursion',
      description: 'Base cases, call stack reasoning, divide-and-conquer, and recursive decomposition.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 2,
      colorCode: '#7c3aed',
      estimatedHours: 7,
    ...
    },
    {
      name: 'Backtracking',
      slug: 'backtracking',
      description: 'Search trees, pruning, permutations, combinations, and constraint exploration.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 3,
      colorCode: '#c026d3',
      estimatedHours: 10,
    ...
    },
    {
      ...
      description: 'Local-choice strategies, interval choices, scheduling, and proof intuition.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 3,
      colorCode: '#ea580c',
      estimatedHours: 9,
    ...
    },
    {
      name: 'Intervals',
      slug: 'intervals',
      description: 'Merging, overlap checks, sweep-line reasoning, and scheduling ranges.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 3,
      colorCode: '#f59e0b',
      estimatedHours: 7,
    ...
    },
    {
      ...
      description: 'Bit masks, XOR tricks, subsets, and low-level integer operations.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 3,
      colorCode: '#475569',
      estimatedHours: 7,
    ...
    },
    {
      ...
      description: 'Modulo arithmetic, primes, combinatorics, geometry, and numeric edge cases.',
      category: SkillCategory.ALGORITHMS,
      difficultyLevel: 3,
      colorCode: '#ca8a04',
      estimatedHours: 8,
    ...
    },
    {
      ...
      description: 'Schema design, indexing, transactions, consistency, and query trade-offs.',
    ...
    },
    {
      name: 'API Design',
      slug: 'api-design',
      description: 'REST, GraphQL, contracts, pagination, idempotency, and versioning.',
      category: SkillCategory.SYSTEM_DESIGN,
      difficultyLevel: 3,
      colorCode: '#2563eb',
      estimatedHours: 8,
    ...
    },
    {
      name: 'Caching',
      slug: 'caching',
      description: 'Cache-aside, invalidation, TTLs, CDN strategy, and hot-key mitigation.',
      category: SkillCategory.SYSTEM_DESIGN,
      difficultyLevel: 3,
      colorCode: '#16a34a',
      estimatedHours: 8,
    ...
    },
    {
      ...
      description: 'Replication, consensus, partition tolerance, queues, and fault handling.',
      category: SkillCategory.SYSTEM_DESIGN,
      difficultyLevel: 4,
      colorCode: '#7e22ce',
      estimatedHours: 14,
    ...
    },
    {
      ...
      description: 'Object modeling, class relationships, design patterns, and maintainable APIs.',
      category: SkillCategory.SYSTEM_DESIGN,
      difficultyLevel: 3,
      colorCode: '#a855f7',
      estimatedHours: 10,
    ...
    },
    {
      ...
      description: 'Ownership, bias for action, customer focus, and senior-level judgment stories.',
      category: SkillCategory.BEHAVIORAL,
      difficultyLevel: 2,
      colorCode: '#f97316',
      estimatedHours: 6,
    ...
    },
    {
      name: 'Communication',
      slug: 'communication',
      description: 'Clarifying requirements, explaining trade-offs, collaboration, and stakeholder alignment.',
      category: SkillCategory.BEHAVIORAL,
      difficultyLevel: 2,
      colorCode: '#eab308',
      estimatedHours: 5,
    ...
    },
    {
      name: 'TypeScript',
      slug: 'typescript',
      description: 'Static typing, generics, narrowing, interfaces, and scalable frontend/backend code.',
      category: SkillCategory.LANGUAGE_SPECIFIC,
      difficultyLevel: 2,
      colorCode: '#3178c6',
      estimatedHours: 9,
    ...
    },
    {
      name: 'Python',
      slug: 'python',
      description: 'Python syntax, standard library fluency, data structures, and idiomatic solutions.',
      category: SkillCategory.LANGUAGE_SPECIFIC,
      difficultyLevel: 1,
      colorCode: '#3776ab',
      estimatedHours: 8,
    ...
    },
    {
      name: 'Java',
      slug: 'java',
      description: 'Collections, OOP, generics, concurrency basics, and JVM interview patterns.',
      category: SkillCategory.LANGUAGE_SPECIFIC,
      difficultyLevel: 2,
      colorCode: '#b91c1c',
      estimatedHours: 10,
    ...
    },
    {
      name: 'C++',
      slug: 'cpp',
      description: 'STL, memory model basics, templates, performance, and competitive-style syntax.',
      category: SkillCategory.LANGUAGE_SPECIFIC,
      difficultyLevel: 3,
      colorCode: '#00599c',
      estimatedHours: 10,
    ...
    },
    {
      name: 'React',
      slug: 'react',
      description: 'Components, hooks, state management, rendering behavior, and frontend architecture.',
    ...
    },
    {
      name: 'Node.js',
      slug: 'nodejs',
      description: 'Event loop, async I/O, APIs, streams, and backend service implementation.',
      category: SkillCategory.FRAMEWORK,
      difficultyLevel: 2,
      colorCode: '#15803d',
      estimatedHours: 9,
    ...
    },
    {
      name: 'Express.js',
      slug: 'expressjs',
      description: 'Routing, middleware, validation, error handling, and REST API structure.',
      category: SkillCategory.FRAMEWORK,
      difficultyLevel: 2,
      colorCode: '#374151',
      estimatedHours: 6,
    ...
    },
    {
      name: 'SQL',
      slug: 'sql',
      description: 'Joins, aggregation, window functions, indexing, and relational query reasoning.',
      category: SkillCategory.DATA_STRUCTURES,
      difficultyLevel: 2,
      colorCode: '#0f766e',
      estimatedHours: 8,
